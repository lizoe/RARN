...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='/raid/name/lixiao/datasets/raf-basic')
...
def main():
    ...
    scheduler = torch.optim.lr_scheduler.StepLR(optimizer, step_size=10, gamma=0.1)  # step_size=10
    ...
    train_dataset = RafDataSet(args.data, phase='train', transform=data_transforms)
    ...
    val_dataset = RafDataSet(args.data, phase='test', transform=data_transforms_val)
